...
function () {
  function AmplifyAmazonButton(hostRef) {
    ...
    this.federatedSignIn = function (response) {
      ...
      if (!_aws_amplify_auth__WEBPACK_IMPORTED_MODULE_5__["Auth"] || typeof _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_5__["Auth"].federatedSignIn !== 'function' || typeof _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_5__["Auth"].currentAuthenticatedUser !== 'function') {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4
                /*yield*/
                , _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_5__["Auth"].federatedSignIn('amazon', {
                  token: access_token,
              ...
              case 1:
                ...
                return [4
                /*yield*/
                , _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_5__["Auth"].currentAuthenticatedUser()];
  ...
  AmplifyAmazonButton.prototype.signInWithAmazon = function (event) {
    ...
    window['amazon'].Login.authorize({
      ...
      try {
        window.localStorage.setItem(_constants_3e1b5fcc_js__WEBPACK_IMPORTED_MODULE_4__["h"], JSON.stringify({
          provider: 'amazon'
        }));
      } catch (e) {
  ...
  AmplifyAmazonButton.prototype.render = function () {
    ...
    return Object(_index_82dae9d1_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-sign-in-button", {
      onClick: function onClick(event) {
        return _this.signInWithAmazon(event);
      },
      provider: "amazon"
    }, Object(_index_82dae9d1_js__WEBPACK_IMPORTED_MODULE_0__["h"])("script", {
  ...
  function AmplifyAuth0Button(hostRef) {
    ...
    this.handleLoad = function () {
      ...
      _this._auth0.parseHash(function (err, authResult) {
        ...
        try {
          localStorage.setItem(_constants_3e1b5fcc_js__WEBPACK_IMPORTED_MODULE_4__["h"], JSON.stringify(payload));
        } catch (e) {
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  ...
                  return [4
                  /*yield*/
                  , _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_5__["Auth"].federatedSignIn(config.domain, {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4
                /*yield*/
                , _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_5__["Auth"].federatedSignIn('facebook', {
                  token: accessToken,
                  expires_at: expires_at
                }, user)];
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              ...
              return [4
              /*yield*/
              , _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_5__["Auth"].federatedSignIn('google', {
                token: id_token,
                expires_at: expires_at
              }, {
...
function () {
  ...
  AmplifyOAuthButton.prototype.signInWithOAuth = function (event) {
    event.preventDefault();
    _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_5__["Auth"].federatedSignIn();
  };
