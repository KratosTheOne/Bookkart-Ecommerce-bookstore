...
export class AmplifyTOTPSetup {
    ...
    render() {
        return (h("amplify-form-section", { headerText: this.headerText, submitButtonText: I18n.get(Translations.TOTP_SUBMIT_BUTTON_TEXT), handleSubmit: event => this.verifyTotpToken(event), loading: this.loading },
